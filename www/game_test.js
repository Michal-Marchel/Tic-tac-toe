...
game2.move(1, 1);
game2.move(2, 2);
console.assert(game2.diagonal(Game.player_O), "El jugador no ha ganado");
console.log("Juego 3");
const game3 = new Game();
game3.move(0, 0);
game3.move(1, 1);
game3.move(2, 2);
console.assert(game3.diagonal(Game.player_O), "El jugador no ha ganado diagonalmente");
console.log("Juego 4");
const game4 = new Game();
game4.move(0, 0);
game4.move(1, 0);
game4.move(2, 0);
console.assert(game4.vertical(Game.player_O), "El jugador no ha ganado verticalmente");
console.log("Juego 5");
const game5 = new Game();
game5.move(0, 0);
game5.move(0, 1);
game5.move(0, 2);
console.assert(game5.horizontal(Game.player_O), "El jugador no ha ganado horizontalmente");
console.log("Juego 6");
